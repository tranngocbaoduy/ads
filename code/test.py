...
#/Users/genkisystem/Downloads/sample.apk
#/Users/genkisystem/Downloads/tiktok-21-7-6.apk
#/Users/genkisystem/Downloads/twitter-9-17-0-release-00.apk
# /Users/genkisystem/Downloads/instagram-212-0-0-29-119.apk
#/Users/genkisystem/Downloads/facebook-343-0-0-13-117.apk
print(desired_caps)
# try:
...
# list_ele = driver.find_elements_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.viewpager.widget.ViewPager/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup')
# for i, ele in enumerate(list_ele):
#     print_detail_elemet(ele)
#     if i == 0:
#         childs = ele.find_elements_by_xpath(".//*")
#         print('parent', print_detail_elemet(ele))
#         print('\tchild', len(childs))
#         for i in childs:
#             if i and (i.text or i.tag_name):
#                 print('\t\t',{
#                     'text':i.text,
#                     'id':i.id,
#                     'tag_name':i.tag_name, 
...
# is_installed = False# driver.is_app_installed('com.twitter.android') 
 
# click_position_y = 540 
# actions = TouchAction(driver)
# list_ele = get_list_post_element(driver, 'facebook')

# while len(list_ele) != 0:
#     # ele_temp = driver.find(ele.id)
#     # height = ele.size['height'] - ele.location['y']
#     if ele.location['y'] == 0:
#         # it's still hidden (move up)
#         print('up')
#         movet = click_position_y - ele.size['height'] 
#     else:
#         # move down 
#         print('down')
#         movet = click_position_y - ele.location['y']

#     # movet = click_position_y - round(height / 2)
#     print_detail_elemet(ele)
#     print('movet',movet, )
#     # actions.press(None, 260, click_position_y).wait(0).move_to(None, 260, movet).release().perform()
#     driver.swipe(260, click_position_y, 260, movet, 2000)
#     time.sleep(2)
#     try:
#         list_ele = driver.find_elements_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.viewpager.widget.ViewPager/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup')
#     except:
#         list_ele = driver.find_elements_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.viewpager.widget.ViewPager/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup')
#     print("Get more", len(list_ele))
# # print(child)
# is_first = False
# # for i in range(0,4):

# # save_ele = []
# # print('index',i,'list_parent',len(list_parent))  
# # try:
# print('lent',len(list_parent))
# for index, c in enumerate(list_parent[len(list_parent)-1]):  
#     # child = c.find_elements_by_class_name("android.view.ViewGroup")
#     # for i in child:
#     #     if i and (i.text or i.tag_name):
#     #         print('\t',{
#     #             'text':i.text,
#     #             'id':i.id
#     #         #     'tag_name':i.tag_name,
#     #         #     'content':i.get_attribute('content-desc')
#     #         })
#     print_detail_elemet(list_parent[index])
#     print_detail_elemet(list_parent[index+1])
#     #         if i.location['x'] == 0:
#     # if not is_first:
#     #     is_first = True
#     #     driver.swipe(540, 100 ,540, -(c.size['height'] + c.location['y']), 1000)
#     # else:
#     # from_ = 100
#     # to_ = c.size['height'] if c.size['height'] <= c.location['y'] else c.size['height'] - c.location['y']
#     # print('\t', from_, to_)
#     scrollObject = dict(strategy="id",selector=c.id,direction="up")
#     driver.execute_script("mobile: scroll", scrollObject)

    # actions.press(list_parent[index]).move_to(list_parent[index+1]).release().perform()
    # driver.swipe(540, from_ ,540, -to_, 1000)
        #         # save_ele.append(i)
        # print('==')
    # except:
    # #     print("error")
...
# print(len(save_ele))
# for index, k in enumerate(save_ele):
    # a1 = TouchAction(driver)
    # a1.press(save_ele[index])
    # a1.move_to(save_ele[index+1])
    # a1.release() 
    # a1.perform()

    # driver.swipe(540, 540 ,540, -(1801-540), 1000)
# scroll_by_screen(driver)
...
#     # open app
#     driver.activate_app('com.twitter.android') 
#     state = driver.query_app_state('com.twitter.android')  
        
#     print('is_installed',is_installed)
    
#     is_out = False
#     try:
#         el = driver.find_element_by_id('com.twitter.android:id/ocf_button')
#         el.click()
#         print("el",el)
#     except:
#         print('not find twitter ocf_button')
#         is_out = True
...
#             '.auth.api.signin.ui.SignInActivity',
#             '.signin.activity.SignInActivity'
#         ]
#         while get_activity(driver) not in activities_google:
#             time.sleep(2)
...
# # print(video)
# print(len(video), )
# fh = open("/Users/genkisystem/Desktop/test2.mp4", "wb")
# fh.write(base64.b64decode(video))
# fh.close()
